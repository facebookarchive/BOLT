...
void ReorderBasicBlocks::runOnFunctions(BinaryContext &BC) {
  ...
  Parallelism::WorkFuncTy WorkFun = [&](BinaryFunction &BF) {
  ...
  Parallelism::runOnEachFunction(
      BC, Parallelism::SchedulingPolicy::SP_BB_LINEAR, WorkFun, SkipFunc,
      "ReorderBasicBlocks");
...
void FinalizeFunctions::runOnFunctions(BinaryContext &BC) {
  ...
  Parallelism::runOnEachFunction(
      BC, Parallelism::SchedulingPolicy::SP_CONSTANT, WorkFun,
...
void CheckLargeFunctions::runOnFunctions(BinaryContext &BC) {
  ...
  Parallelism::runOnEachFunction(
      BC, Parallelism::SchedulingPolicy::SP_INST_LINEAR, WorkFun,
